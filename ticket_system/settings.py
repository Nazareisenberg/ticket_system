...
SECRET_KEY = 'django-insecure-5%a7p7j40)*v8y8fdf1zh^(u2unk$41ba_9rgodw%t#k26^wtv'
...
LOGIN_URL = 'users:login'  # Имя пути для входа
LOGOUT_URL = 'users:logout'  # Имя пути для выхода
LOGIN_REDIRECT_URL = 'flights:flight_list'  # Куда перенаправлять после входа
LOGOUT_REDIRECT_URL = 'users:login'  # Куда перенаправлять после выхода
  # Или используйте имя маршрута
